...
enum AlgoTimingEvent {
    ...
    AlgoTimingEvent_FormalLKAttempt,
    AlgoTimingEvent_FormalLKSuccess,
    AlgoTimingEvent_FormalLKFailure,
    AlgoTimingEvent_FormalLKROIFailure,
    AlgoTimingEvent_FormalMatchFallback,
